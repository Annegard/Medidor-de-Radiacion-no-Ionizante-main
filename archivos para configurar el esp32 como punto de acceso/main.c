...
void Publisher_Task(void *params){
    ...
    while (true){
        ...
        cJSON_AddStringToObject(root, "name", "SENSOR1");
        cJSON_AddNumberToObject(root, "potencia", pot);
        ...
        if(MQTT_CONNEECTED){   
            ...
            cJSON_AddStringToObject(root, "name", "SENSOR2");
            cJSON_AddNumberToObject(root, "potencia", 30.5);
            cJSON_AddNumberToObject(root, "latitud", -30);
            cJSON_AddNumberToObject(root, "longitud", -62);
