...
void app_main()
{
    ...
    estadoModo=MENU_PRINCIPAL;//Inicializo la variable estadoModo
    Auxiliar = estadoModo;//cargo en la variable auxiliar el estadoModo
...
void actualizardisplay(){
    ...
    switch (estadoModo)
    {
      ...
      case CONECTAR_GPS:
        ...
        lcd_print("LON");
        lcd_gotoxy(9, 1);
        Print_Float_LCD(Longitud);

        lcd_gotoxy(5, 2);
        lcd_print("LAT");
        lcd_gotoxy(9, 2);
        Print_Float_LCD(Latitud);
         break;
      ...
      case MEDIR_POTENCIA:
        ...
        lcd_print("Vol");
        lcd_gotoxy(9, 1);
        Print_Float_LCD(voltaje_promedio);
        lcd_gotoxy(14, 1);
        lcd_print("V");
